...
const getAvatar = (name) =>
  avatarPalette[(name || "A").charCodeAt(0) % avatarPalette.length];
...
const Card = ({ _id, name, prompt, photo }) => {
  ...
  return (
    <div
      className="rounded-2xl group relative overflow-hidden card transition-all duration-300 hover:-translate-y-1 bg-white"
      ...
      <div
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/90 text-xs font-medium truncate max-w-[90px]">
              {name || "Anonymous"}
            </span>
          </div>
